...
public class ClienteController {
    ...
    public ClienteController(){
        ...
        clientes = Stream.of(
                ClienteModel.builder().id(1L).nome("Flavio").idade(18).telefone("33223322").pais(paises.get(0)).limiteCredito(1000.0).build(),
                ClienteModel.builder().id(2L).nome("Evandro").idade(19).telefone("44339988").pais(paises.get(0)).limiteCredito(1800.0).build()
        ).collect(Collectors.toList());
    }
